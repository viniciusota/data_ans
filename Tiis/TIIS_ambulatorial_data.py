...
def get_url_list():
    ...
    primary_url = "http://ftp.dadosabertos.ans.gov.br/FTP/PDA/TISS/AMBULATORIAL/{}/{}.zip"
    list_url = []
    key_path = []
    for year in period:
        for state in list_state:
             list_url.append( primary_url.format(  year , state  ) )   
             key_path.append("my_bucket/dados_publicos/TIIS_AMBULATORIAL_{}/{}/{}{}.zip".format( date.today() , year , state , year ))
